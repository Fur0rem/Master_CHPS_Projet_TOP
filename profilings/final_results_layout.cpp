/**
 * @file profilings/final_results_layout.cpp
 * @brief Used to compare cache hit ratio of the best layout combinaison of the matrix product for the final results.
 */
...
auto main(int argc, char* argv[]) -> int {
	...
	for (int i = 0; i < 10; i++) {
		Kokkos::fence();
		matrix_product_reference(alpha, A_right, B_left, beta, C_right);
		Kokkos::fence();
	}
